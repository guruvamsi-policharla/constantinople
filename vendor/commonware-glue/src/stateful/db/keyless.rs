...
{
    type Unmerkleized =
        KeylessUnmerkleized<F, E, FixedEncoding<V>, FixedJournal<E, fixed::Operation<F, V>>, H>;
    type Merkleized =
        KeylessMerkleized<F, E, FixedEncoding<V>, FixedJournal<E, fixed::Operation<F, V>>, H>;
    type Error = Error<F>;
    ...
    H: Hasher + 'static,
{
    ...
    >;
    type Error = Error<F>;
    type Config = variable::Config<<variable::Operation<F, V> as CodecRead>::Cfg>;
    type SyncTarget = sync::Target<F, H::Digest>;
